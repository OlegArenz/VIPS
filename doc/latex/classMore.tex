...
\subsubsection[{\texorpdfstring{update\+\_\+surrogate(vec regression\+\_\+weights, mat X, vec targets, double ridge\+\_\+factor, bool omit\+\_\+linear\+\_\+term, bool no\+\_\+correlations)}{update_surrogate(vec regression_weights, mat X, vec targets, double ridge_factor, bool omit_linear_term, bool no_correlations)}}]{\setlength{\rightskip}{0pt plus 5cm}bool More\+::update\+\_\+surrogate (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\hypertarget{classMore_a5bb1da06e25a581a06d4c84359702e7b}{}\label{classMore_a5bb1da06e25a581a06d4c84359702e7b}
Fits a quadratic surrogate using weighted ridge regression and stores the result in the member variables 
\begin{DoxyParams}{Parameters}
{\em regression\+\_\+weights} & \\
\hline
{\em X} & \\
\hline
{\em targets} & \\
...
{\em ridge\+\_\+factor} & \\
\hline
{\em omit\+\_\+linear\+\_\+term} & \\
\hline
{\em no\+\_\+correlations} & \\
\hline
\end{DoxyParams}
\index{More@{More}!update\+\_\+surrogate\+\_\+normalize\+Data@{update\+\_\+surrogate\+\_\+normalize\+Data}}
\index{update\+\_\+surrogate\+\_\+normalize\+Data@{update\+\_\+surrogate\+\_\+normalize\+Data}!More@{More}}
\subsubsection[{\texorpdfstring{update\+\_\+surrogate\+\_\+normalize\+Data(vec regression\+\_\+weights, mat X, vec targets, mat cov, vec mean, double ridge\+\_\+factor, bool standardize, bool omit\+\_\+linear\+\_\+term, bool no\+\_\+correlations)}{update_surrogate_normalizeData(vec regression_weights, mat X, vec targets, mat cov, vec mean, double ridge_factor, bool standardize, bool omit_linear_term, bool no_correlations)}}]{\setlength{\rightskip}{0pt plus 5cm}bool More\+::update\+\_\+surrogate\+\_\+normalize\+Data (
\begin{DoxyParamCaption}
\item[{vec}]{regression\+\_\+weights, }
\item[{mat}]{X, }
\item[{vec}]{targets, }
...
\item[{bool}]{no\+\_\+correlations}
\end{DoxyParamCaption}
)}\hypertarget{classMore_a0943909cf34c607dba952bf65f724702}{}\label{classMore_a0943909cf34c607dba952bf65f724702}
Fits a quadratic surrogate using weighted ridge regression and stores the result in the member variables 
\begin{DoxyParams}{Parameters}
{\em regression\+\_\+weights} & \\
\hline
