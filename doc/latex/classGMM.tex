...
\subsubsection[{\texorpdfstring{add\+\_\+components\+\_\+at\+\_\+locations(mat means, bool scale\+\_\+entropy, bool isotropic)}{add_components_at_locations(mat means, bool scale_entropy, bool isotropic)}}]{\setlength{\rightskip}{0pt plus 5cm}void G\+M\+M\+::add\+\_\+components\+\_\+at\+\_\+locations (
\begin{DoxyParamCaption}
\item[{mat}]{new\+\_\+means, }
\item[{bool}]{scale\+\_\+entropy, }
\item[{bool}]{isotropic}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\hypertarget{classGMM_a16b4be29710b9754b3276c649ede42b5}{}\label{classGMM_a16b4be29710b9754b3276c649ede42b5}
...
\begin{DoxyParams}{Parameters}
{\em means} & -\/ matrix of size N\+\_\+dimensions x N\+\_\+new\+Components specifying \\
\hline
{\em scale\+\_\+entropy} & -\/ if true, scale the entropy of the Gaussian such that it corresponds to the average entropy  p(o) H(p(x$\vert$o)) \\
\hline
{\em isotropic} & -\/ if true, return an isotropic (identity if scale\+\_\+entropy = False) covariance instead of interpolating. at which positions new components are to be added \\
\hline
\end{DoxyParams}
...
\subsubsection[{\texorpdfstring{evaluate\+\_\+\+G\+M\+M\+\_\+densities\+\_\+low\+\_\+mem(mat samples, bool uniform\+\_\+weights=false)}{evaluate_GMM_densities_low_mem(mat samples, bool uniform_weights=false)}}]{\setlength{\rightskip}{0pt plus 5cm}vec G\+M\+M\+::evaluate\+\_\+\+G\+M\+M\+\_\+densities\+\_\+low\+\_\+mem (
\begin{DoxyParamCaption}
\item[{mat}]{samples, }
\item[{bool}]{uniform\+\_\+weights = {\ttfamily false}}
\end{DoxyParamCaption}
)}\hypertarget{classGMM_ab7e827d443107567eb5c4e5791158005}{}\label{classGMM_ab7e827d443107567eb5c4e5791158005}
...
\hline
{\em uniform\+\_\+weights} & -\/ evaluate the \hyperlink{classGMM}{G\+MM} densities assuming that p(o) is uniform \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\subsubsection[{\texorpdfstring{interpolate\+\_\+covs\+\_\+for\+\_\+query\+\_\+points(mat query\+\_\+points, bool scale\+\_\+entropy, bool isotropic)}{interpolate_covs_for_query_points(mat query_points, bool scale_entropy, bool isotropic)}}]{\setlength{\rightskip}{0pt plus 5cm}cube G\+M\+M\+::interpolate\+\_\+covs\+\_\+for\+\_\+query\+\_\+points (
\begin{DoxyParamCaption}
\item[{mat}]{query\+\_\+points, }
\item[{bool}]{scale\+\_\+entropy, }
\item[{bool}]{isotropic}
\end{DoxyParamCaption}
)}\hypertarget{classGMM_a5b867d2bbe2d3eebbd871bd1e99eabd2}{}\label{classGMM_a5b867d2bbe2d3eebbd871bd1e99eabd2}
...
{\em scale\+\_\+entropy} & -\/ if true, scale the entropy of the Gaussian such that it corresponds to the average entropy  p(o) H(p(x$\vert$o)) \\
\hline
{\em isotropic} & -\/ if true, return an isotropic (identity if scale\+\_\+entropy = False) covariance instead of interpolating. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
