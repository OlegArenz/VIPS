...
from experiments.lnpdfs.create_target_lnpfs import build_target_likelihood_planar_n_link_3
from time import time
from mpi4py import MPI

num_dimensions = 10
conf_likelihood_var = 1e-1 * np.ones(num_dimensions)
conf_likelihood_var[0] = 1
cart_likelihood_var = np.array([1e-4, 1e-4])

[target_lnpdf, prior, prior_chol] = build_target_likelihood_planar_n_link_3(num_dimensions, conf_likelihood_var, cart_likelihood_var)
...
if __name__ == '__main__':
    sample(100000, './ptmcmcm_10link_4default', True)
