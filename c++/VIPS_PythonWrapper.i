...
%apply (double* INPLACE_ARRAY1, int DIM1) {
    ...
    (double * lb_weights_in, int lb_weights_in_dim1),
...
public:
    ...
    void compute_KLs_between_GMM_and_DB_components(bool reverse_KL, float ** KL_mat_out_ptr,
                                                    int * KL_mat_out_dim1, int * KL_mat_out_dim2);
};
